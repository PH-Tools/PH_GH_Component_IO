...
try:
    from ph_gh_component_io.input_tools import clean_get, input_to_int
except ImportError:
...
class IGH:
    """Interface for basic Grasshopper (and Rhino) dependencies that can be
    ...
    def merge_Face3D(self, _face3Ds):
        ...
        for face3D in _face3Ds:
            ...
            faces, edges, vertices = self.ghpythonlib_components.DeconstructBrep(
                rh_brep
            )
